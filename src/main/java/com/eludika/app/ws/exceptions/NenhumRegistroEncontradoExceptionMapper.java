 ...
 */
@Provider
public class NenhumRegistroEncontradoExceptionMapper implements
        ExceptionMapper<NenhumRegistroEncontradoException> {

    @Override
    public Response toResponse(NenhumRegistroEncontradoException exception) {
